...
function VehicleHistoryFilter({
  ...
  useEffect(() => {
    try {
      axios
        .get("http://localhost:5000/parameter/centers")
        .then((res) => {
  ...
  const fetchFilteredHistory = async () => {
    ...
    try {
      await axios
        .post(`http://localhost:5000/owner/vehicles/${vehicleId}/filter`, {
          filterData,
        })
        .then((res) => {
  ...
  const handleFilterSubmit = () => {
    ...
    handleClose();
    setAlertMessage(`Successfully Filtered History !`);
  ...
  return (
    <div>
      ...
      >
                  ...
                  <DemoContainer components={["DatePicker", "DatePicker"]}>
                    <DatePicker
                      ...
                      onChange={(event, newValue) =>
                        handleChange(event, newValue, "fromDate")
                      }
                ...
                >
                  <DemoContainer components={["DatePicker", "DatePicker"]}>
                    <DatePicker
                      ...
                      onChange={(event, newValue) =>
                        handleChange(event, newValue, "toDate")
                      }
                      inputFormat="DD-MM-YYYY"
                    />
                  </DemoContainer>
        ...
        <Button sx={{ mb: 0.5 }} onClick={handleFilterSubmit}>
          Apply Filter <FilterAltOutlinedIcon />
        </Button>
        <Button sx={{ mb: 1.5 }} onClick={handleClearFilter}>
          Clear Filter
